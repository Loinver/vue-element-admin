<template>
  <div class="area-select-wrap">
    <el-select
      ...
      :disabled="disabled"
    >
      <el-option v-for="(val, key) in provinces" :key="key" :label="val" :value="key" />
    </el-select>
    ...
    >
      ...
      <el-option v-for="(val, key) in citys" v-else :key="key" :label="val" :value="key" />
    </el-select>
    ...
    >
      ...
      <el-option v-for="(val, key) in areas" v-else :key="key" :label="val" :value="key" />
    </el-select>
  </div>
</template>
